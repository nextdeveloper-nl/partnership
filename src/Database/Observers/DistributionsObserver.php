...
class DistributionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Partnership\Distributions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Partnership\Distributions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Partnership\Distributions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Partnership\Distributions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Partnership\Distributions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Partnership\Distributions', $model);
    }
