...
class AccountsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Partnership\Accounts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Partnership\Accounts', $model);
    }
