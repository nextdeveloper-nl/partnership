...
class ProductionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Partnership\Productions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Partnership\Productions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Partnership\Productions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Partnership\Productions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Partnership\Productions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Partnership\Productions', $model);
    }
