...
'partnershipdistributionsperspective' => function ($value) {
        return NextDeveloper\Partnership\Database\Models\PartnershipDistributionsPerspective::findByRef($value);
},
...
'partnershipcustomer' => function ($value) {
        return NextDeveloper\Partnership\Database\Models\PartnershipCustomer::findByRef($value);
},
